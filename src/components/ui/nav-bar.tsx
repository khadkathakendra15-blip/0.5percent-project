  ...
  return (
    <>
      ...
      <nav style={{
        ...
        borderBottom: solid ? '1px solid rgba(244,237,224,0.08)' : 'none',
      ...
      {mobileOpen && (
        <div style={{
          ...
          background: INK, borderBottom: '1px solid rgba(244,237,224,0.1)',
          ...
          {LINKS.map(l => (
            <Link
              ...
              style={{
                ...
                padding: '14px 0', borderBottom: '1px solid rgba(244,237,224,0.07)',
              }}
            >
              {l.label}
            </Link>
